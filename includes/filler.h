...
/*   Updated: 2018/04/14 13:34:21 by nobrien          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	calculate_heatmap(t_env *g, int (get_heat_number)(t_env *, int, int, int));

int		overflows(t_env *g, int y, int x);
int		place_piece(t_env *g, int (*cmp)(t_env *, int, int, int (get_points)(t_env *, int, int)));
...
int		o_place_piece(t_env *g, int (*cmp)(t_env *g, int x, int y, int (get_points)(t_env *, int, int)));
